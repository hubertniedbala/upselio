  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="px-4 py-2.5 bg-primary text-white rounded-md shadow border border-primary flex items-center gap-2 hover:bg-primary-dark transition-colors">
